            ...
            items: [
                {
                    ...
                    submenu: [
                        { name: "View Meter Locations", link: "/dashboard/meter/view-locations" },
                        { name: "View History", link: "/dashboard/meter/view-history" },
                        { name: "Compare Meter Data", link: "/dashboard/meter/compare" },
                ...
                },
                {
                    ...
                    icon: <MdOutlineCo2 />,
                    submenu: [
                        { name: "View", link: "/dashboard/carbon/view" },
                        { name: "Compare", link: "/dashboard/carbon/compare" },
                    ],
                    roles: ["super_admin", "system_admin", "user"],
                },
            ],
